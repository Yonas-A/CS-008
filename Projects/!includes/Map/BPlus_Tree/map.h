...
class Map {
   public:
    ...
    ///        greatest element in Multimap, or if Multimap is empty
    ...
    /// @returns true if mmap satisfies its underlining structure's
    ...
    /// prints keys and value of print_me onto the screen
    void print_map_tree();
