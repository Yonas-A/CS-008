...
void test_attach_item()
{
    cout << "=  =   =   test  attach_item() =  =   =" << endl << endl;
    ...
    cout << "=  =   =   exiting attach_item() test =  =  =" << endl << endl;

}

void test_copy_array()
{
    cout << "=  =   =   copy_array() test =  =  =" << endl << endl;
    ...
    cout << "=  =  =  exiting copy_array() test =  =  =" << endl << endl;
}

void test_delete_item()
{
    cout << "=  =   =   delete_item() test =  =  =" << endl << endl;
    ...
    cout << "=  =   = exiting delete_item() test =  =" << endl << endl;
}

void test_detach_item()
{
    cout << "=  =   =   attach_item() test =  =  =" << endl << endl;
    ...
    cout << "=  =   =   exiting detach_item() test =  =  =" << endl << endl;
}

void test_first_ge()
{
    cout << "=  =   =   first_ge() test =  =  =" << endl << endl;
    ...
    cout << "=  =   =   exiting first_ge() test =  =  =" << endl << endl;
...
void test_insert_item()
{
    cout << "=  =   =   insert_item() test =  =  =" << endl << endl;
    ...
    cout << "=  =   = exiting insert_item() test =  =" << endl << endl;
}

void test_is_gt()
{
    cout << "=  =   =   is_gt() test =  =  =" << endl << endl;
    ...
    cout << "=  =  =   exiting is_gt() test =  =  =" << endl << endl;
}

void test_is_le()
{
    cout << "=  =   =   is_le() test =  =  =" << endl << endl;
    ...
    cout << "=  =  =   exiting is_le() test =  =  =" << endl << endl;
}
...
void test_maximal()
{
    ...
    cout << "=  =  =   exiting merge() test =  =  =" << endl << endl;
}
...
void test_split()
{
    ...
    cout << "=  =  =   exiting split() test =  =  =" << endl << endl;
}
...
void test_overloaded_PLUS_OPERATOR()
{
    cout << "=  =   = vector overloaded + test =  =  =" << endl << endl;
    ...
    cout << "LHS size: " << lhs.size() << endl << lhs << endl << endl;
    cout << "RHS size: " << rhs.size()  << endl << rhs << endl << endl;
    ...
    vec = lhs + rhs ;
    cout << endl;
    cout << "VEC size: " << vec.size()  << endl << vec << endl << endl;
...
void test_overloaded_PLUS_EQUAL()
{
    ...
    cout << "VEC size: " << vec.size()  << endl << vec << endl << endl;
    cout << "LIST size: " << list.size() << endl << list << endl << endl;
    ...
    cout << endl;
    cout << "hold size: " << hold.size()  << endl << hold << endl << endl;
