...
#include "../../!includes/Union_n_Intesection/union_n_intersection.h"
...
vector<long> RPN::operator()( Table& t )
{
    ...
    while( !rpn_temp.Empty( ) )
    {
                 ...
                 static_cast<TokenType>(TokenType::operators)  )
        {
                ...
                hold == ">" || hold == ">=" || hold == "==")
            {
                ...
                /// find the records that satisfy these conditons and operator
    ...
    heapSort_function( &v );
    if ( DEBUG )
        cout << "final RPN vector: " << endl << v << endl;
    return v;
}
